        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="py-12">
                ...
                <p className="mt-4 text-lg text-gray-500 dark:text-gray-300">
                    This is the help page. It will contain information about how to use the site. *TODO: Change This*
                </p>
            </div>
            ...
            <div className="py-6">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white sm:text-3xl">
                    How do I get confirmation that I am signed up for an activity?
                </h2>
                <p className="mt-4 text-lg text-gray-500 dark:text-gray-300">
                    We will email you with a confirmation that your application was sent to the organization and we will remind you an hour before the activity starts that it is happening today.
                </p>
            </div>
        </main>
    );
