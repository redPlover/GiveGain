...
export default function Home() {
    return (
        <main className="flex min-h-screen flex-col items-center justify-between p-24">
            ...
            <h1 className="relative shrink md:flex md:items-center place-items-center drop-shadow-md mb-20 px-8 text-9xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-br from-green-400 to-blue-500 dark:from-green-500 dark:to-blue-600">
                GiveGain
            </h1>
            {/* </div> */}

            <p className="relative shrink md:flex md:items-center place-items-center drop-shadow-md max-w-[70ch] mb-10 text-xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-br from-green-900 to-blue-900 dark:from-green-500 dark:to-blue-600">
